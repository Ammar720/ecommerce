...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.singleton<_i25.AuthRepository>(() => _i177.AuthRepositoryImpl(
          gh<_i385.AuthRemoteDataSource>(),
          gh<_i395.AuthLocalDataSource>(),
        ));
    gh.singleton<_i658.Login>(() => _i658.Login(gh<_i25.AuthRepository>()));
    gh.singleton<_i696.Register>(
        () => _i696.Register(gh<_i25.AuthRepository>()));
