...
import 'package:ecommerce/features/auth/data/data_sources/local/auth_local_data_source.dart'
    as _i395;
import 'package:ecommerce/features/auth/data/data_sources/local/auth_shared_pref_data_source.dart'
    as _i287;
...
import 'package:ecommerce/features/auth/presentation/cubit/auth_cubit.dart'
    as _i350;
import 'package:ecommerce/features/home/data/data_sources/remote/home_remote_api_data_source.dart'
    as _i702;
import 'package:ecommerce/features/home/data/data_sources/remote/home_remote_data_source.dart'
    as _i329;
import 'package:ecommerce/features/home/data/repositories/home_repositorey_impl.dart'
    as _i1043;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.lazySingleton<_i329.HomeRemoteDataSource>(
        () => _i702.HomeRemoteApiDataSource(gh<_i361.Dio>()));
    gh.singleton<_i395.AuthLocalDataSource>(
        () => _i287.AuthSharedPrefDataSource(gh<_i460.SharedPreferences>()));
    gh.lazySingleton<_i572.HomeRepository>(
        () => _i1043.HomeRepositoreyImpl(gh<_i329.HomeRemoteDataSource>()));
